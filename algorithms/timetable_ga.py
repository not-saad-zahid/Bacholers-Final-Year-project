...
class TimetableGeneticAlgorithm:
    def __init__(self,
                *,
                ...
                max_generations=100,
                mutation_rate=0.15):
        # Use the entries passed in from the UI
    ...
    def _generate_time_slots(self):
        ...
        print("GA time slots:", slots) # DEBUG: show GA slot list
        return slots
    ...
    def calculate_fitness(self, timetable):
        ...
        for (course, class_sec, instance), details in timetable.items():
            ...
            if room_key in room_usage:
                score += 50  # Major penalty for room double-booking
            ...
            if teacher_key in teacher_usage:
                score += 40  # Penalty for teacher double-booking
            ...
            if class_key in class_usage:
                score += 60  # Severe penalty for class double-booking
            ...
            if day_conflicts[day][class_sec] > 3:
                score += 15  # Penalty for 4+ classes same day for same section
            ...
            if day_conflicts[teacher_day_key] > 3:
                score += 10  # Penalty for excessive teacher workload per day
